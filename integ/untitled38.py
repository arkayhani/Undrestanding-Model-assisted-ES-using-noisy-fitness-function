...
def f2(y,x,l,r,z1):
    return pe(x,l,r)*y*pq(y,l,r)/z1#*(1.0/cdf(y/r))#
def f3(y,l,r,z):
    return y*pq(y,l,r)/z
def f4(y,l,r):
    return pq(y,l,r)
def f5(y,x,l,r,z):
    return pe(x,l,r)*pq(y,l,r)
#def f(x,l,r):
...
for i in b:
    ...
    z=(integrate.nquad(f5, [boundy,[-np.inf,0]],args=(a,i,1))[0]/integrate.nquad(f5, [[-np.inf,+np.inf],[-np.inf,0]],args=(a,i,1))[0])
    z1=(integrate.nquad(f5, [boundy,[0,np.inf]],args=(a,i,1))[0]/integrate.nquad(f5, [[-np.inf,+np.inf],[0,np.inf]],args=(a,i,1))[0])
    ...
    h.append(integrate.nquad(f2, [[0,np.inf],[0,np.inf]],args=(a,i,z1))[0]+integrate.nquad(f1, [boundy,[-np.inf,0]],args=(a,i,z))[0])
